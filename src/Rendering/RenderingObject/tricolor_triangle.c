...
FC3D_DLL_EXPORT fc3d_rendering_object_interface const fc3d_tricolor_triangle_rendering_interface =
{
    ...
    .DepthRasterization = &fc3d_tricolor_triangle_DepthRasterization,
